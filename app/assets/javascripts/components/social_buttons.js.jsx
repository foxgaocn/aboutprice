    ...
    return (
      <div id='social-buttons'>
        <div className="button-on-big">
          ...
          <a className="fa fa-envelope-o share-base share-mail" href='mailto:?to=&body=http://www.priceadvisor.com.au' title="share to friends"></a>
          <a className="fa fa-comment share-base share-contact" href='mailto:?to=admin@priceadvisor.com.au' title="contact us"></a>
        </div>
      </div>
    );
  },
